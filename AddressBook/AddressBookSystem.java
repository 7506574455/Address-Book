...
class AddressBookSystem {
	...
	private static ContactData contactFunctions = new ContactData();
	public Map<String, ContactData> addressBookListMap = new HashMap<>();
	...
	public static void main(String[] args) {
		AddressBookSystem addressBookMain = new AddressBookSystem();
		boolean flag = true;
		while (flag) {
			...
			case 2:
				for (Map.Entry<String, ContactData> entry : addressBookMain.addressBookListMap.entrySet()) {
	...
	private void searchPersonByState(String stateName) {
		...
		for (Map.Entry<String, ContactData> entry : addressBookListMap.entrySet()) {
			ContactData value = entry.getValue();
