...
public class ContactData {
	...
	public void addContactDetails() {
		...
		Contact contactDetails = new Contact(firstName, lastName, address, city, state, email, phoneNumber,
				zip);
	...
	/*
	 * Check Duplicate Entry bu using set if first name in the contactLits is same
	 */
	public void checkDuplicate() {
	        Set<String> ContactSet = new HashSet<>();
	        Set<Contact> filterSet = contactList.stream().filter(n -> !ContactSet.add(n.getFirstName())).collect(Collectors.toSet());
	    ...
	    public void getPersonNameByState(String State) {
	        List<Contact> list  = contactList.stream().filter(p ->p.getState().equals(State)).collect(Collectors.toList());
